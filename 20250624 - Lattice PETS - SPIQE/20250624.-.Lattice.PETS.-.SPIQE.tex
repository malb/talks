...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc339641}]{The Learning with Errors Problem (LWE)}
...
\end{frame}
\begin{frame}[label={sec:orge8f9674}]{LWE}
\[
...
\begin{frame}[label={sec:org6367bd7}]{Verifiable Oblivious PRFs}
\procedure{}{%
...
\end{frame}
\begin{frame}[label={sec:org3d69ad0}]{Example Applications: Privacy Pass}
\begin{columns}[t]
...
\end{frame}
\begin{frame}[label={sec:org7462ea4}]{DH-Based OPRF}
\centering
\procedure{}{%
...
\end{frame}
\begin{frame}[label={sec:org17f3327}]{``Just take Logs''}
\centering
\procedure{}{%
\textbf{Client} \< \< \textbf{Server}\\
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4272309}]{The Trouble}
\begin{description}
...
\label{sec:org990097b}

\begin{frame}[label={sec:org8a0f9e1}]{The Problem}
\begin{align*}
H(x)\cdot\alert{k} + \alert{e}\cdot\alert{k} + \alert{e'}  - \alert{e''} \cdot \alert{r}
&\approx H(x)\cdot\alert{k}\\
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org75303ab}]{Rounding}
\centering
\begin{tikzpicture}
  \draw (0,0) circle (2cm);
