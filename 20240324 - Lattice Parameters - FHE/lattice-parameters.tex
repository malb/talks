...
\label{sec:orgad93292}
\begin{frame}[label={sec:org1946572}]{Learning with Errors}
...
\begin{frame}[label={sec:org8ee20f3}]{Learning with Errors}
Given \((\mathbf{A},\vec{c})\), find \(\vec{s}\) when
...
\begin{frame}[label={sec:org4a4df0e}]{Unique SVP: Computational Problem}
...
\begin{frame}[label={sec:org57ac7a7}]{Approx SVP/SIS: Translation}
\begin{itemize}
...
\begin{frame}[label={sec:org973ab10}]{Approx SVP: Computational Problem}
...
\begin{frame}[label={sec:org8cd6c55}]{Lattice Reduction <3 Combinatorics: Hybrid Attacks}
...
\begin{frame}[label={sec:orga0194b3}]{Strong Lattice Reduction: BKZ Algorithm (Block 0)}
\centering
...
\begin{frame}[label={sec:orgb728eb5}]{Strong Lattice Reduction: BKZ Algorithm (Block 1)}
\centering
\(\left(\begin{array}{ccccccccc}
\phantom{\pi_0(\vec{b}_0)} &
\phantom{\pi_0(\vec{b}_1)} &
...
\begin{frame}[label={sec:org69bc3e7}]{BKZ Algorithm}
\begin{algorithm}[H]
...
\begin{frame}[label={sec:orgdc7476b},fragile]{Quality}
 \centering
...
\begin{frame}[label={sec:org8915556},fragile]{Try it at Home}
 \begin{lstlisting}[language=Python,label= ,caption= ,captionpos=b,numbers=none]
from fpylll import *
...
\begin{frame}[label={sec:org611c1e2}]{Success Condition for uSVP (Expectation)}
%\vspace{-2.6em}
...
\begin{frame}[label={sec:org007a8a6}]{Success Condition for uSVP (Observed)}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org5a73db0}]{The GSA is a Lie: Tail Shape}
\tikzset{external/export=true}
...
\section{Solving SVP}
\label{sec:orgf4b1f93}
\begin{frame}[label={sec:org9afbe03}]{Solving SVP}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgff8696d}]{Enumeration I -- Pick a radius}
\begin{center}
...
\begin{frame}[label={sec:orgcc48501}]{Enumeration II -- Project basis}
\begin{center}
...
\begin{frame}[label={sec:orgd5fb079}]{Enumeration III -- Project lattice}
\begin{center}
...
\begin{frame}[label={sec:org54483ad}]{Enumeration IV -- Enumerate projections}
\begin{center}
...
\begin{frame}[label={sec:org4c327a3}]{Enumeration V -- For each lift and enumerate}
\begin{center}
...
\begin{frame}[label={sec:org5a2b503}]{Enumeration V -- For each lift and enumerate}
\begin{center}
...
\begin{frame}[label={sec:org5a2b857}]{Enumeration VI -- Keep shortest}
\begin{center}
...
\begin{frame}[label={sec:org6e4ff44}]{Fast Enumeration}
\begin{itemize}
...
\begin{frame}[label={sec:org74bf6fe},fragile]{Practical Performance (Simulation)}
 \tikzset{external/export=true}
...
\begin{frame}[label={sec:org8f4c731}]{Sieving: Key Idea I}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org023e0ad}]{Sieving: Key Idea II}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org2e5bd9f}]{Sieving: Key Idea III}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:orgde0c510}]{Sieving: Basic (Gauss) Sieve Complexity}
\begin{itemize}
...
\begin{frame}[label={sec:org28ccab6}]{Sieving: Buckets I}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org4daa519}]{Sieving: Buckets II}
...
\begin{frame}[label={sec:orgfad9eb4}]{Sieving: G6K}
...
\begin{frame}[label={sec:org6e6c18b}]{Sieving: SVP}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org31883f2}]{Darmstadt HSVP\textsubscript{1.05} Challenges}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:orgc3f00c9}]{Attack Description}
\begin{columns}
...
\begin{frame}[label={sec:org77562cc}]{Comparison with State of the Art: SALSA VERDE I}
\begin{center}
...
\begin{frame}[label={sec:orgd684027}]{Comparison with State of the Art: SALSA VERDE II}
\begin{center}
