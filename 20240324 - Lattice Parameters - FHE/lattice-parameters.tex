...
\label{sec:org80679ad}
\begin{frame}[label={sec:org8397cea}]{Learning with Errors}
...
\begin{frame}[label={sec:orgf5b5a85}]{Learning with Errors}
Given \((\mathbf{A},\vec{c})\), find \(\vec{s}\) when
...
\begin{frame}[label={sec:org85075d4}]{Unique SVP: Computational Problem}
...
\begin{frame}[label={sec:org32ae6fd}]{Approx SVP/SIS: Translation}
\begin{itemize}
...
\begin{frame}[label={sec:org5618a23}]{Approx SVP: Computational Problem}
...
\begin{frame}[label={sec:org4553c70}]{Lattice Reduction <3 Combinatorics: Hybrid Attacks}
...
\begin{frame}[label={sec:orgef1dedf}]{Strong Lattice Reduction: BKZ Algorithm (Block 0)}
\centering
...
\begin{frame}[label={sec:orgdbc1d73}]{Strong Lattice Reduction: BKZ Algorithm (Block 1)}
\centering
\(\left(\begin{array}{ccccccccc}
\phantom{\pi_0(\vec{b}_0)} &
\phantom{\pi_0(\vec{b}_1)} &
...
\begin{frame}[label={sec:orgc43bca2}]{BKZ Algorithm}
\begin{algorithm}[H]
...
\begin{frame}[label={sec:org3741bca},fragile]{Quality}
 \centering
...
\begin{frame}[label={sec:org01ea00f},fragile]{Try it at Home}
 \begin{lstlisting}[language=Python,label= ,caption= ,captionpos=b,numbers=none]
from fpylll import *
...
\begin{frame}[label={sec:org1c8dfff}]{Success Condition for uSVP (Expectation)}
%\vspace{-2.6em}
...
\begin{frame}[label={sec:orgeeb5a2a}]{Success Condition for uSVP (Observed)}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org58f6dd8}]{The GSA is a Lie: Tail Shape}
\tikzset{external/export=true}
...
\section{Solving SVP}
\label{sec:org110f5fe}
\begin{frame}[label={sec:org9fa124a}]{Solving SVP}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org043d9d1}]{Enumeration I -- Pick a radius}
\begin{center}
...
\begin{frame}[label={sec:orgb647bbb}]{Enumeration II -- Project basis}
\begin{center}
...
\begin{frame}[label={sec:org9b86c91}]{Enumeration III -- Project lattice}
\begin{center}
...
\begin{frame}[label={sec:orga7b7858}]{Enumeration IV -- Enumerate projections}
\begin{center}
...
\begin{frame}[label={sec:org3bdf004}]{Enumeration V -- For each lift and enumerate}
\begin{center}
...
\begin{frame}[label={sec:orgb9a7fd6}]{Enumeration V -- For each lift and enumerate}
\begin{center}
...
\begin{frame}[label={sec:orgfb07b0b}]{Enumeration VI -- Keep shortest}
\begin{center}
...
\begin{frame}[label={sec:orgce812e1}]{Fast Enumeration}
\begin{itemize}
...
\begin{frame}[label={sec:org52db479},fragile]{Practical Performance (Simulation)}
 \tikzset{external/export=true}
...
\begin{frame}[label={sec:orgf2575b0}]{Sieving: Key Idea I}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org680e1e7}]{Sieving: Key Idea II}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org9e1ade7}]{Sieving: Key Idea III}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:orgc67326b}]{Sieving: Basic (Gauss) Sieve Complexity}
\begin{itemize}
...
\begin{frame}[label={sec:org85487c1}]{Sieving: Buckets I}
\tikzset{external/export=true}
...
\begin{frame}[label={sec:org53bef6c}]{Sieving: Buckets II}
...
\begin{frame}[label={sec:org49631fb}]{Sieving: G6K}
...
\begin{frame}[label={sec:org2bede4c}]{Sieving: SVP}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:orga4b7307}]{Darmstadt HSVP\textsubscript{1.05} Challenges}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:orgdfb5318}]{Attack Description}
\begin{columns}
...
\begin{frame}[label={sec:orgc657ed7}]{Comparison with State of the Art: SALSA VERDE I}
\begin{center}
...
\begin{frame}[label={sec:orgb02cbbe}]{Comparison with State of the Art: SALSA VERDE II}
\begin{center}
