#+title: Estimating the Difficulty of Breaking Lattice-Based Cryptography
...
- KCL :: recruiting academic staff, postdocs and PhD students (across areas of cryptography)
- SandboxAQ :: recruiting (maybe staff), postdocs and interns (post-quantum focused)
