...
\begin{frame}[label={sec:orge39578d}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:org7c3d3d6}]{FHE-schemes based on LWE}
\footnotesize
...
\begin{frame}[label={sec:org3b9ccaf}]{Lattice Attacks}
\begin{description}
...
\begin{frame}[label={sec:org33359cb}]{Base Line}
\begin{center}
...
\label{sec:orgd0fec51}
\begin{frame}[label={sec:org54591b3}]{Modulus Switching}
\begin{lemma}
...
\begin{frame}[label={sec:orgab0c6f3}]{Modulus Switching in Cryptanalysis}
When the secret is much smaller than the noise, applying modulus switching produces an easier LWE problem.
\end{frame}

\begin{frame}[label={sec:org5efd9c3}]{Modulus Switching: Sieving}
\begin{center}
\begin{tikzpicture}[scale=0.95]
  \begin{axis}[
    legend pos=outer north east,
...
\begin{frame}[label={sec:org2a0b1e3}]{Coded-BKW}
...
\begin{frame}[label={sec:orgd21c9bc}]{Coded-BKW}
\begin{center}
\#+BEGIN\(_{\text{LATEX}}\)
\begin{tikzpicture}[scale=0.95]
  \begin{axis}[
...
\begin{frame}[label={sec:orgf427093}]{Modulus Switching for Dual Attack}
\begin{lemma}
...
\begin{frame}[label={sec:org18c175c}]{Modulus Switching: Sieving}
\begin{center}
\begin{tikzpicture}[scale=0.95]
  \begin{axis}[
    legend pos=outer north east,
...
\label{sec:org1e0e9b7}
\begin{frame}[label={sec:org950dbb6}]{Exploiting Sparse Secrets}
...
\begin{frame}[label={sec:org40a2daa}]{Postprocessing}
...
\begin{frame}[label={sec:org32f66e0}]{Ignoring Components}
\begin{center}
\begin{tikzpicture}[scale=0.95]
  \begin{axis}[
    legend pos=outer north east,
