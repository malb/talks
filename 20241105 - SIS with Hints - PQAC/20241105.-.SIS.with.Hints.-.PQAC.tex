...
\begin{frame}[label={sec:org42d6b4d}]{Knowledge K-R-ISIS: The Audacity}
\begin{center}
\includegraphics[width=.9\linewidth]{./pun.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc330aed}]{Knowledge K-R-ISIS: Almost Instant Karma}
...
\begin{frame}[label={sec:orgbcd1c52}]{\(h\)-PRISIS}
...
\begin{frame}[label={sec:org1ba9ebe}]{Hardness}
