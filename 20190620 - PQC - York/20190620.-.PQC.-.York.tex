...
\begin{frame}[label={sec:orgaae8e73}]{Symmetric v Asymmetric Primitives}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
\textbf{Symmetric Primitives}
...
\begin{frame}[label={sec:org18f7277}]{Don’t Jump the Gun!}
\begin{itemize}
...
\begin{frame}[label={sec:orgfed82f4},standout]{Fin}
\begin{center}
