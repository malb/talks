% Created 2019-02-28 Thu 10:18
% Intended LaTeX compiler: pdflatex
\documentclass[xcolor=table,10pt,aspectratio=169,handout]{beamer}
\usepackage{graphicx}
\usepackage{grffile}
...
\label{sec:org8ee60c1}

\begin{frame}[label={sec:org15cad8d}]{About Me}
\begin{itemize}
...
\begin{frame}[label={sec:orgeaceadb}]{Essential Cryptographic Primitives}
\begin{columns}[t]
...
\begin{frame}[label={sec:orge688afb}]{Essential Cryptographic Primitives: Theoretical Perspective}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
\textbf{Minicrypt}
...
\begin{frame}[label={sec:orgcab693c}]{Symmetric v Asymmetric Primitives}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
\textbf{Symmetric Primitives}
...
\begin{frame}[label={sec:org8dbc810}]{Symmetric v Asymmetric Primitives: Quantum Computing Perspective}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
\textbf{Symmetric Primitives}
...
\label{sec:org5225089}
\begin{frame}[label={sec:orgf7e7803}]{Post-Quantum Cryptography}
\begin{definition}
...
\begin{frame}[label={sec:org96c0615}]{Post-Quantum Standardisation}
\begin{description}
...
\begin{frame}[label={sec:org6ac6c5f},fragile]{NIST PQC {\color{lightgray}{Competition} }Process}
 \textbf{Timeline}
...
\begin{frame}[label={sec:org91b6d1e}]{Security Notions}
\begin{description}
...
\begin{frame}[label={sec:org073f174}]{Post-Quantum Candidate Families}
\begin{columns}[t]
...
\begin{description}
\item[{17 KEMs}] \alert<1>{BIKE}, \alert<1>{Classic McEliece}, \alert<5,7>{CRYSTALS-KYBER}, \alert<5,7>{FrodoKEM}, HQC, \alert<5,7>{LAC}, \alert<1>{LEDAcrypt}, \alert<5,7>{NewHope}, \alert<5,7>{NTRU}, \alert<5,7>{NTRU Prime}, \alert<1>{NTS-KEM}, \alert<1>{ROLLO}, \alert<5,7>{Round5}, \alert<1>{RQC}, \alert<5,7>{SABER}, \alert<4>{SIKE}, \alert<5,7>{Three Bears}.
...
\begin{frame}[label={sec:org03b38d8}]{KEM: Code-based}
...
\begin{frame}[label={sec:org4db4699}]{KEM: Lattice-based}
...
\begin{frame}[label={sec:orgd470cb2}]{KEM: SIKE}
...
\begin{frame}[label={sec:org9c758d7}]{SIG: OWF-based}
...
\begin{frame}[label={sec:org12b1869}]{SIG: Lattice-based (Hash-and-Sign)}
...
\begin{frame}[label={sec:org99dd120}]{SIG: MQ-based}
...
\label{sec:org73d0530}
\begin{frame}[label={sec:org9b9f270}]{Parameters Matter}
\begin{quote}
...
\begin{frame}[label={sec:org73daa0b}]{PQ Candidates are not DH}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org67000f4}]{Alternatives: QKD?}
\begin{quote}
...
\begin{frame}[label={sec:org68957c2}]{The Road Ahead}
\begin{itemize}
...
\begin{frame}[label={sec:orgd5ff95e}]{Don’t Jump the Gun!}
\begin{itemize}
...
\begin{frame}[label={sec:org07f153f},standout]{Fin}
\begin{center}
