...
\begin{frame}[label={sec:orgf1cc1eb}]{Symmetric v Asymmetric Primitives}
\begin{columns}[t]
\begin{column}{0.5\columnwidth}
\textbf{Symmetric Primitives}
...
\begin{frame}[label={sec:org3acc15f}]{Don’t Jump the Gun!}
\begin{itemize}
...
\begin{frame}[label={sec:org4cd0309},standout]{Fin}
\begin{center}
